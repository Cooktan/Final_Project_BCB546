...
<<<<<<< HEAD
vst_cor<- as.matrix(cor(Anther_length_w_genes, method="spearman"))
...
=======
pheatmap(vst_cor,border_color="white",labels_col =NA, labels_row = NA, treeheight_row = 0, treeheight_col = 0, cluster_rows = 0)
>>>>>>> 75ec95c1eddc6e756db7ffdb6de02d443eea7d92

=======
vst_cor<- as.matrix(cor(Anther_length_w_genes1, method="spearman"))
>>>>>>> c026ff6d20ccd7a937457bd644d5964f952a9506
...
>>>>>>> 75ec95c1eddc6e756db7ffdb6de02d443eea7d92
=======
autoplot(PCA_256, data=rna4_x2, size=5, colour= 'anther_size_mm') + geom_line(aes(group = cell))+ scale_color_gradient2(low = "gray",high = "black", space = "Lab" )+theme_bw()
>>>>>>> c026ff6d20ccd7a937457bd644d5964f952a9506
...
```{r}
library(FactoMineR)
pca <- PCA(rna4_log3[, -c(1:3)], scale.unit=TRUE, ncp=10, graph=T)

pca$eig
most_variable <- dimdesc(pca)
most_variable$Dim.2
