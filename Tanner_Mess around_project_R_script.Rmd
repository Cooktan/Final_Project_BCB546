...
y
y$gene<-NULL
vst_cor <- as.matrix(cor(y, method="spearman"))
...
library(scater)
ANTHER5_MAT=as.vector(ANTHER5)
by.cluster <- aggregateAcrossCells(RNA, ids=colLabels(ANTHER5_MAT))
centroids <- reducedDim(by.cluster, "PCA")

######

## Heatmap by with data sorted with 
