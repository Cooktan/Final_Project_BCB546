...
#Need Pseudotime calculation and how to merge files into dataset
##ggplot() +
  ##geom_point(data = c(ago18a,I$s), aes(I$s,1), color = "blue")
#Can use Juans anther code on marker genes for similar result
...
#Subset the Marker Genes in pr1 and pr2
...
#Need to change scale of graph and add normalization to expression data
```
