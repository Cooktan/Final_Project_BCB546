...
plot(I)
plot(I$lambda)
plot(PCA2$center) # any of the PCA names can be called here (where x is)
...
## Heat map...
Variance2000transcriptsRJ=inner_join(rna_final_Tanner,s3 )
Variance2000transcriptsRJ$gene<-NULL
vst_cor <- as.matrix(cor(Variance2000transcriptsRJ, method="spearman"))

Variance2000transcriptsRJ[is.na(Variance2000transcriptsRJ)] = 0

pheatmap(vst_cor,border_color=NA)
